...
namespace fst
{
    ...
    public:
        ...
        math::Vector3f computeBrdf(const math::Vector3f& wi, const math::Vector3f& wo, const math::Vector3f& normal, HitRecord &hitRecord , std::vector<Texture> &textures , math::Vector3f &point , math::Vector3f &rad) const;
